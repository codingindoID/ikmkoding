			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center">
						<a href="<?php echo site_url('khusus/detil/').$data['id_responden'] ?>" class="btn-sm btn-warning"  title="detil"><i class="fa fa-eye"></i></a>
						<a target="_blank" href="<?php echo site_url('khusus/cetak_kuisioner/').$data['id_responden'] ?>" class="btn-sm btn-success"  title="detil"><i class="fa fa-print"></i></a>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>

				...
				<table width="60%" >
					<form action="<?php echo site_url('admin/update_admin') ?>" method="post" accept-charset="utf-8">
						<tr>
							...
							<td style="padding: 10px;"><input type="text" name="display" value="<?php echo $admin->display ?>" class="form-control" required></td>
						</tr>
						<tr>
							<td>Username</td>
						...
						<tr >
							<td></td>
							<td style="padding: 10px;"><button type="submit" class="btn bg-purple"><i class="fa fa-save"></i> Simpan Perubahan</button></td>
						</tr>
					</form>
				</table>
			</div>

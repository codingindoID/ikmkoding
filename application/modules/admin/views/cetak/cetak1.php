   ...
   <body>
     <?php
      ...
      header("Content-Disposition: attachment; filename= SURVEY_KEPUASAN_MASYARAKAT_" . $bulan . "_" . $tahun . ".xls");
      ?>
     <div class="table-responsive">
       <table class="table" border="1" style="border-collapse: collapse;">
         <thead>
           <tr>
             <th colspan="9" style="text-align: center;">REKAP KEPUASAN MASYARAKAT</th>
           </tr>
           <?php if ($bulan != 'setahun') : ?>
             <tr>
               <th colspan="9">BULAN : <?= $bulan ?> | TAHUN : <?= $tahun ?></th>
             </tr>
           <?php else : ?>
             <tr>
